...
mandatory_tag_map = {
  "active.compliance.account"              = "477021940959"
  ...
  "active.operations.environment"          = "development"
  "active.operations.environment-sub-type" = "development" // Environment
